...
class Args():
    def __init__(self):
        ### Output file of batch time. Custom made for profiling reason
        self.batch_time_output_file = None
        ...
        self.epochs = 10**6 # now one epoch means self.batch_ratio x batch_size
