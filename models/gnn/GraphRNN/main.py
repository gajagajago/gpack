...
if __name__ == '__main__':
    ...
    batch_time_output_file = sys.argv[1]
    print("Batch time output saved at: ", batch_time_output_file)
    if batch_time_output_file:
        args.batch_time_output_file = batch_time_output_file
