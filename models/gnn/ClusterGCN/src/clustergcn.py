...
# Added by @gajagajago for profiling test
...
class ClusterGCNTrainer(object):
    ...
    def train(self):
        ...
        # TODO: currently not saving to tensorboard_path
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=0,warmup=10,active=10,repeat=2),
