...
(timeout 5m nvidia-smi -i 0,1,2,3 --query-gpu=utilization.gpu --format=csv >> gpu_util_$outfilename.csv -l 1;)&
...
timeout 5m bash /mnt/code/train_distributed.sh 4 /mnt/data/ \
