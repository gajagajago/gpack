...
def run():
    ...
    parser.add_argument("--tensorboard-path", type=str, default="/mnt/logs/dlrm")
    parser.add_argument("--steps-this-run", type=int, default=5000)
    ...
    if use_gpu:
        ...
        print("set cudnn to be deterministic...")
